...
class MarkDetector:
    ...
    def __init__(self, mark_model=None):
        """Initialization"""
        ...
        if mark_model.split(".")[1] == "pb":
            ...
            with custom_object_scope({'smoothL1': smoothL1}):
                self.sess = load_model(mark_model)

    def detect_marks(self, image_np, mark_model=None):
        ...
        if mark_model.split(".")[1] == "pb":
            ...
            predictions = self.sess.predict(image_np)
